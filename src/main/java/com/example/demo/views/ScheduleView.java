...
public class ScheduleView extends VerticalLayout {
    ...
    public ScheduleView(AuthenticationContext authenticationContext, TeamsService teamsService, AgesService agesService, GamesService gamesService
...
////        add(div, disclaimer, br1, sunTitle,sunLocation,sun);
        ...
        add(new ScheduleGrid(authenticationContext, teamsService, agesService, gamesService, seasonsService, locationsService));
        add(new Footer());
